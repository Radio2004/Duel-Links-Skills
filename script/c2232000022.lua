...
function s.flipcon2(e,tp,eg,ep,ev,re,r,rp)
	...
	local b2=Duel.GetFlagEffect(tp,id+2)==0 and Duel.IsExistingMatchingCard(s.sephylon,tp,LOCATION_HAND,0,1,nil) and Duel.GetFlagEffect(tp,Duel.GetTurnCount())~=Duel.GetTurnCount()
