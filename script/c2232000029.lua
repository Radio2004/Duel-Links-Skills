...
function s.flipcon(e,tp,eg,ep,ev,re,r,rp)
	...
	local b1=Duel.GetFlagEffect(tp,id)==0 and Duel.IsExistingMatchingCard(s.revealtfilter,tp,LOCATION_HAND,0,1,nil) and Duel.IsExistingMatchingCard(s.filter2,tp,LOCATION_DECK|LOCATION_HAND,0,2,nil,tp)
...
function s.operation_for_res0(e,tp,eg,ep,ev,re,r,rp)
	...
	if #reveal>0 then
		...
		local g=Duel.SelectMatchingCard(tp,s.filter2,tp,LOCATION_DECK|LOCATION_HAND,0,2,2,nil,tp)
		if #g>1 then
